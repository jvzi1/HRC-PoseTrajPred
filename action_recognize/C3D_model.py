...
class C3D(nn.Module):
    def __init__(self, num_classes, pretrained=True):
        ...
        self.relu = nn.LeakyReLU(0.1)  # 定义激活函数ReLU
    ...
    def __load__pretrained_weights(self):
        ...
        p_dict = torch.load(r'F:\video_rec_new\ucf101-caffe.pth')  # 加载预训练权重，预训练权重是一个字典格式，里面包含定义的网络层和对应的权重值
...
if __name__ == "__main__":
    ...
    net = C3D(num_classes=6).to(device)
